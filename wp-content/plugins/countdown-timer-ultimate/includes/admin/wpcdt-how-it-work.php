	...
	<div class="wrap wpcdt-wrap">
		...
		<?php
			if( isset($active_tab) && $active_tab == 'how-it-work' ) {
				...
				echo wpcdt_get_plugin_design( 'offers-feed' );
			}
		?>
...
function wpcdt_help_tabs() {
	$wpos_feed_tabs = array(
						...
						'offers-feed' 	=> array(
													'name'				=> __('Hire US', 'countdown-timer-ultimate'),
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="http://docs.wponlinesupport.com/countdown-timer-ultimate/" target="_blank"><?php _e('Documentation', 'countdown-timer-ultimate'); ?></a>
													<a class="button button-primary" href="http://demo.wponlinesupport.com/countdown-timer-ultimate-demo/" target="_blank"><?php _e('Demo for Designs', 'countdown-timer-ultimate'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/countdown-timer-ultimate/" target="_blank"><?php _e('Go Premium ', 'countdown-timer-ultimate'); ?></a>
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/countdown-timer-ultimate-pro/circle-countdown-timer/" target="_blank"><?php _e('View PRO Demo ', 'countdown-timer-ultimate'); ?></a>	</p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
