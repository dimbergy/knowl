...
register_nav_menus( array(
	...
	'secondary' => __( 'Secondary Menu', 'sage' ),
	'white' => __( 'White Menu', 'sage' ),
	'registration' => __( 'Registration Menu', 'sage' ),
	'temporary' => __( 'Temporary Menu', 'sage' ),
) );
...
function program() {
	...
	$labels = array(
		'name'                  => _x( 'Programs', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'Program', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'Programs', 'knowl' ),
		'name_admin_bar'        => __( 'Program', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New Program', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'Program', 'knowl' ),
		'description'           => __( 'Programs Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function news() {
	...
	$labels = array(
		'name'                  => _x( 'News', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'News', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'News', 'knowl' ),
		'name_admin_bar'        => __( 'News', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New New', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'News', 'knowl' ),
		'description'           => __( 'news Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function coordinator() {
	...
	$labels = array(
		'name'                  => _x( 'Coordinators', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'Coordinator', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'Coordinators', 'knowl' ),
		'name_admin_bar'        => __( 'Coordinator', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New Coordinator', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'Coordinator', 'knowl' ),
		'description'           => __( 'Coordinators Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'coordinators', $args );

}
add_action( 'init', 'coordinator', 0 );
...
function company() {
	...
	$labels = array(
		'name'                  => _x( 'Companies', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'Company', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'Companies', 'knowl' ),
		'name_admin_bar'        => __( 'Company', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New Company', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'Company', 'knowl' ),
		'description'           => __( 'Companies Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function cycle() {
	...
	$labels = array(
		'name'                  => _x( 'Cycles', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'Cycle', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'Cycles', 'knowl' ),
		'name_admin_bar'        => __( 'Cycle', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New Cycle', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'Cycle', 'knowl' ),
		'description'           => __( 'Cycles Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'cycles', $args );
...
// Register Custom Post Type
function cycle_arcive() {

	$labels = array(
		'name'                  => _x( 'Cycles Archive', 'Post Type General Name', 'knowl' ),
		'singular_name'         => _x( 'Cycle Archive', 'Post Type Singular Name', 'knowl' ),
		'menu_name'             => __( 'Cycles Archive', 'knowl' ),
		'name_admin_bar'        => __( 'Cycle Archive', 'knowl' ),
		'archives'              => __( 'Item Archives', 'knowl' ),
		'attributes'            => __( 'Item Attributes', 'knowl' ),
		'parent_item_colon'     => __( 'Parent Item:', 'knowl' ),
		'all_items'             => __( 'All Items', 'knowl' ),
		'add_new_item'          => __( 'Add New Item', 'knowl' ),
		'add_new'               => __( 'Add New Cycle Archive', 'knowl' ),
		'new_item'              => __( 'New Item', 'knowl' ),
		'edit_item'             => __( 'Edit Item', 'knowl' ),
		'update_item'           => __( 'Update Item', 'knowl' ),
		'view_item'             => __( 'View Item', 'knowl' ),
	...
	$args = array(
		'label'                 => __( 'Cycle Archive', 'knowl' ),
		'description'           => __( 'Cycles Archive Description', 'knowl' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions', 'custom-fields', 'excerpt' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'cycles_archive', $args );

}
add_action( 'init', 'cycle_arcive', 0 );
