...
<div id="regform" style="height:40px">
	 ...
	 date_default_timezone_set('Europe/Athens') ;
	  ...
	  $date_exp = date('2018-09-10 23:59:59');
 ...
              
	   ...
	   <?php if($date_now < $date_exp): ?>
   		<?php echo do_shortcode( '[contact-form-7 id="2813" title="Goldair Form EN"]' ); ?>
		<?php else: ?>
 ...
        </div>      
	    ...
	    <?php if($date_now < $date_exp): ?>
  	 <?php echo do_shortcode( '[contact-form-7 id="2812" title="Goldair Form GR"]' ); ?>
    	<?php else: ?>
